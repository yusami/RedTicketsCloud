...
def mocked_redmine(*args, **kwargs):
    ...
    class MockRedmine:
        def __init__(self, url, key=kwargs['key']):
            assert url is not None, "URL should be valid."
            ...
            assert self.project is not None, "MockProjects instance should be created."
            ...
            assert self.issue is not None, "Issues should be valid."
    ...
    class MockProjects:
        def __init__(self, redmine):
            assert redmine is not None, "Redmine instance should be valid."
        ...
        def all(self, offset, limit):
            assert self.__projects is not None, "Projects should be created."
    ...
    class MockIssues:
        def __init__(self, redmine, project):
            assert redmine is not None, "Redmine argv should be valid."
            assert project is not None, "Project argv should be valid."
            assert project.identifier is not None, "Project identifier should be valid."
        ...
        def all(self, offset, limit, sort, include):
            assert self.__issues is not None, "Issues should be created."
